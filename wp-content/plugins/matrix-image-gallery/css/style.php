...
.textmatrixfree {
	position: absolute;
		color: #fff;
	 background-image:url(\'http://localhost/word/wp-content/plugins/matrixfree-pro/images/textbg.png\');
...
position: relative;
	margin: 0px;
	padding:0px;
	 background-image:url(\''.$site_url.'/wp-content/plugins/matrixfree-pro/images/shadow.png\');
	list-style: none;
