...
function twentythirteen_header_style() {
	...
	?>
		/*START DISABLE DEFAULT HEADER
		.site-header {
			background: url(<?php header_image(); ?>) no-repeat scroll top;
			background-size: 1600px auto;
		}
		END DISABLE DEFAULT HEADER*/
		/*START RESPONSIVE HEADER - 140614 WAIKIT*/
		.site-header {
            background: url("http://cubicdesign.cu.cc/wp-content/uploads/2014/09/bannerweb-01.jpg") no-repeat scroll top;
        }
        @media (max-width: 999px){

            .site-header {

            background: url("http://i1370.photobucket.com/albums/ag259/queennie1206/bannerweb_999_zps178703b5.jpg") scroll top;
        ...
        @media (max-width: 500px){
            ...
            background: url("http://i1370.photobucket.com/albums/ag259/queennie1206/bannerweb_500_zpsfdfe94a6.jpg") scroll top;

        }

        }
		/*END RESPONSIVE HEADER - 140614 WAIKIT*/
	<?php
		endif;
